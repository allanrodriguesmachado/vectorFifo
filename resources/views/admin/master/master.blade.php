...
<div class="dash">
    <aside class="dash_sidebar">
        ...
        <ul class="dash_sidebar_nav">
            ...
            <li {{isActive('admin.users')}} class="dash_sidebar_nav_item"><a class="icon-users" href="{{route('admin.users.index')}}">Clientes</a>
                <ul class="dash_sidebar_nav_submenu">
                    ...
                    <li class="{{isActive('admin.users')}}"><a href="{{route('admin.users.team')}}">Time</a></li>
                    <li class="{{isActive('admin.users')}}"><a href="{{route('admin.users.create')}}">Criar Novo</a></li>
                </ul>
            </li>
